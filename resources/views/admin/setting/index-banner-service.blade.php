    ...
    <div class="card-body">
        <div class="row align-items-center justify-content-between">
            <div class="col-md-2 mt-3">
                <a href="{{ route('show.setting-banner-service.form') }}" class="btn btn-dark btn-sm d-flex align-items-center justify-content-center w-80">
                    <span>Tambah</span>
                </a>
            </div>
        </div>
            ...
            <table class="table table-hover text-center">
                ...
                <tbody>
                        ...
                        <td class="align-middle">
                            ...
                            <td>
                                <div class="d-flex justify-content-center align-items-center gap-2">
                                    <a href="{{ route('show.setting-banner-service.form', $banner->id) }}" class="btn btn-warning btn-sm" title="Edit Banner" data-bs-toggle="tooltip">
                                        <i class="fas fa-edit"></i>
                                    </a> | 
                                    <form id="form-delete-{{ $banner->id }}" 
                                          action="{{ route('show.setting-banner-service.delete', $banner->id) }}" 
                                          method="post" 
                                          class="d-inline">
                                          @csrf 
                        ...
                        <div class="col-12 text-center py-5">
                            <i class="material-symbols-rounded text-muted mb-3 fs-1">ad</i>
