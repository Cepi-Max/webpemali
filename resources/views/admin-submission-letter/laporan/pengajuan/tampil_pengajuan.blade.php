...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex items-center justify-between mb-6">
        <h2 class="text-2xl font-bold text-gray-800">Laporan Data Pengajuan</h2>
        <div class="">
            <a href="{{ route('laporan.pengajuan.print') }}" target="_blank"
            ...
            <a href="{{ route('laporan.pengajuan.download') }}" target="_blank"
        ...
        <table class="min-w-full divide-y divide-gray-200 text-sm text-gray-700">
            <thead class="bg-gray-100">
                <tr>
                    ...
                    <th class="px-4 py-2 font-semibold text-left">Nama Pemohon</th>
                    <th class="px-4 py-2 font-semibold text-left">Jenis Pelayanan</th>
                    <th class="px-4 py-2 font-semibold text-left">Tanggal Pengajuan</th>
            ...
            <tbody class="divide-y divide-gray-200">
                ...
                <tr class="bg-white hover:bg-gray-50">
                    ...
                    <td class="px-4 py-2">{{ $item->pemohon->name ?? '-' }}</td>
                    <td class="px-4 py-2">{{ $item->jenisSurat->nama ?? '-' }}</td>
                    <td class="px-4 py-2">{{ \Carbon\Carbon::parse($item->tanggal_pengajuan)->format('d-m-Y') }}</td>
