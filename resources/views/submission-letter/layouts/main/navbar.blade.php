    ...
    <div class="w-full">
        ...
        <div class="h-20 bg-sky-950 dark:bg-gray-900 flex items-center justify-between px-4 transition-all duration-300">
            ...
            <nav class="">
                <div class="block sm:hidden right-0 flex items-center">
                    ...
                    <!-- Icon when menu is closPengajuaned -->
                ...
                <div class="hidden sm:flex items-center gap-4 p-4">
                    ...
                    <div class="hover:border-b-2 hover:border-orange-500">
                        <a href="{{ route('show.community-services.dashboard') }}" class="block rounded-md px-3 py-2 text-base text-white dark:text-gray-200 {{ request()->routeIs('show.community-services.dashboard'  . '*') ? 'bg-gray-900 dark:bg-gray-700' : '' }}">Pelayanan Tersedia</a>
                    </div>
                    <div class="hover:border-b-2 hover:border-orange-500">
                        <a href="{{ route('show.mysubmission') }}" class="block rounded-md px-3 py-2 text-white dark:text-gray-200 {{ request()->routeIs('show.mysubmission'  . '*') ? 'bg-gray-900 dark:bg-gray-700' : '' }}">Pengajuan Saya</a>
                    </div>
                    <div class="hover:border-b-2 hover:border-orange-500">
                        <a href="{{ route('show.historymysubmission') }}" class="block rounded-md px-3 py-2 text-white dark:text-gray-200 {{ request()->routeIs('show.historymysubmission'  . '*') ? 'bg-gray-900 dark:bg-gray-700' : '' }}">Riwayat</a>
                    </div>
        ...
        <div class="sm:hidden bg-sky-950 dark:bg-gray-900 w-full" x-show="open" x-cloak x-transition @click.away="open = false">
            <div class="px-2 pb-3 pt-2">
                ...
                <a href="{{ route('show.community-services.dashboard') }}" class="block rounded-md px-3 py-2 text-base font-medium text-white dark:text-gray-200 {{ request()->routeIs('show.community-services.dashboard'  . '*') ? 'bg-gray-900 dark:bg-gray-700' : '' }}">Pelayanan Tersedia</a>
                <a href="{{ route('show.mysubmission') }}" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 text-white dark:text-gray-200 {{ request()->routeIs('show.mysubmission'  . '*') ? 'bg-gray-900 dark:bg-gray-700' : '' }}">Pengajuan Saya</a>            
                <a href="{{ route('show.historymysubmission') }}" class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 text-white dark:text-gray-200 {{ request()->routeIs('show.historymysubmission'  . '*') ? 'bg-gray-900 dark:bg-gray-700' : '' }}">Riwayat</a>            
                ...
                @auth
                    <div x-data="{ dropdownOpen : false}" class="relative group">
                        ...
                        <ul x-show="dropdownOpen" 
                            ...
                            <li><a href="{{ route('profile-user.edit') }}" class="block px-3 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white dark:text-gray-200"><span class="{{ request()->routeIs('profile-user.edit' .'*') ? 'border-b-2 border-gray-900 dark:border-gray-300' : '' }}">Profile</span></a></li>
                            @if (Auth::user()->role == 'admin')
